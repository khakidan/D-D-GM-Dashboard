...
- `NpcListEditor.tsx` — Generic list editor for NPC/PC arrays (Traits, Actions, etc). Supports collapsible headers with `defaultExpanded` control and Add/Remove actions with `stopPropagation` protection.
