...
- `StatBlock.tsx` — Orchestrator (~116 lines). Delegates rendering to `StatBlockScoresTable.tsx`, `StatBlockSaves.tsx`, `StatBlockPassive.tsx`, and `StatBlockSkills.tsx`. All five live in `src/components/ui/`.
