...
**Current baseline: 936 tests.** Real, verified totals for every affected batch, run individually per this file's own rule:
...
- **Batch 8: 30 → 38.** Breakdown: 30 (baseline) + 8 (ResourcePoolsSection unit, interaction, and regression tests) = 38.
...
| 8 | `src/components/ui/__tests__` | 38 |
