...
**Other future audit categories, discussed but not yet started** — beyond the bug-hunting, componentization, UI-uniformity, and security work already completed (see `CHANGELOG.md`), a professional React/TypeScript codebase review typically also covers:
