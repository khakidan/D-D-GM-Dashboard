...
describe('buildCombatantsFromState stable PC handling', () => {
  ...
  it('correctly builds stable PC combatant with isStable flag from character sheet when linked', () => {
    const characters: Partial<Character>[] = [{
      id: 'pc-1',
      characterName: 'Alandra',
      currentHp: 0,
    ...
    expect(res[0].isStable).toBe(true);
  });

  it('correctly builds stable PC combatant with isStable flag from character sheet when falling back to active characters', () => {
    const characters: Partial<Character>[] = [{
      id: 'pc-1',
      characterName: 'Alandra',
      currentHp: 0,
  ...
  it('does not mark PC as stable if they have 3 successes but also 3 failures (dead)', () => {
    const characters: Partial<Character>[] = [{
      id: 'pc-1',
      characterName: 'Alandra',
      currentHp: 0,
  ...
  it('does not mark PC as stable if they have fewer than 3 successes', () => {
    const characters: Partial<Character>[] = [{
      id: 'pc-1',
      characterName: 'Alandra',
      currentHp: 0,
